...
{\small
\noindent
I am a motivated software developer transitioning from a career in product management. With a strong foundation in C/C++, I enjoy learning new technologies and am eager to explore all aspects of software development.\\
\\
...
{\small
	\begin{list}{$\bullet$}{}
		\item \href{https://github.com/deniz-oezdemir/Transcendence}{\underline{Pong Web App}}: Currently building a full-stack 3D Pong game with a microservices architecture. It will feature real-time multiplayer functionality, an AI opponent, game statistics, and cross-device compatibility.
